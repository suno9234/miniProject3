...
from app.nodes.search_agent.graph import search_agent_graph
from app.nodes.inventory_agent.graph import inventory_agent_graph
...
def build_graph():
    ...
    graph.add_node("inventory_agent", inventory_agent_graph)
